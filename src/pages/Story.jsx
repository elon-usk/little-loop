...
export default function Story() {
  return (
    <main id="main" className="section container">
      ...
      <p>
        Littlelopp.ro s-a născut din dorința de a fi alături de părinți –
        în special mame – cu ghiduri de activități, recomandări, sfaturi practice,
        idei de sustenabilitate și sprijin real pentru afacerile locale.
      </p>
